var rule = {
    ...
    class_name: '️电影🔹4K&️电视剧🔹4K&️综艺🔹4K&️动漫🔹4K&️少儿🔹4K&️纪录片🔹4K&公众号:万影家视',
    class_url: 'movie&tv&variety&cartoon&child&doco&doco',
    limit: 20,
    play_parse:true,
    // play_parse:true,
 lazy: $js.toString(() => {
    ...
    二级: $js.toString(() => {
        ...
        VOD.vod_play_from = yg.length < 1 ? "VIP️" : "️VIP️$$$ 预告及花絮";
